...
public class LogManageController {
    ...
    public Result<Page<SysOperLog>> pageOperLogs(
        ...
        return Result.ok(operLogService.pageLogs(pageParam, DEFAULT_TENANT_ID, userId, module, status, startTime, endTime));
    }
    ...
    public Result<List<Map<String, Object>>> getModuleStats(
            @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime startTime,
            @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime endTime) {
        return Result.ok(operLogService.getModuleStats(DEFAULT_TENANT_ID, startTime, endTime));
    }
    ...
    public Result<List<Map<String, Object>>> getUserStats(
        ...
        return Result.ok(operLogService.getUserStats(DEFAULT_TENANT_ID, startTime, endTime, limit));
    }
    ...
    public Result<Page<SysLoginLog>> pageLoginLogs(
        ...
        return Result.ok(loginLogService.pageLoginLogs(pageParam, DEFAULT_TENANT_ID, username, loginResult, startTime, endTime));
    }
    ...
    public Result<List<Map<String, Object>>> getDailyLoginStats(
            @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime startTime,
            @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime endTime) {
        return Result.ok(loginLogService.countByDate(DEFAULT_TENANT_ID, startTime, endTime));
    }
    ...
    public Result<List<Map<String, Object>>> detectAbnormalLogin(
        ...
        return Result.ok(loginLogService.detectAbnormalLogin(threshold, minutes));
    }
