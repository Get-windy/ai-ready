...
public class MessageEntity implements Serializable {
    ...
    public static class EmailPayload {
        ...
        // 简化构造函数（3参数）
        public EmailPayload(String to, String subject, String content) {
            this.to = to;
    ...
    public static class SmsPayload {
        ...
        // 简化构造函数（2参数）
        public SmsPayload(String phone, String content) {
            this.phone = phone;
            this.content = content;
        }
    }
    ...
    public static class NotificationPayload {
        ...
        // 简化构造函数（3参数）
        public NotificationPayload(Long userId, String title, String content) {
            this.userId = userId;
            this.title = title;
            this.content = content;
        }
