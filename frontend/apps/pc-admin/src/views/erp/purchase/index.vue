  ...
  <div class="purchase-order-page">
    ...
    >
      <a-descriptions :column="2" bordered>
        ...
        <a-descriptions-item label="订单日期">{{ currentOrder?.orderDate }}</a-descriptions-item>
        <a-descriptions-item label="预计到货日期">{{ currentOrder?.expectedDeliveryDate }}</a-descriptions-item>
        <a-descriptions-item label="采购员">{{ currentOrder?.purchaserName }}</a-descriptions-item>
        ...
        <a-descriptions-item label="税额">¥{{ currentOrder?.taxAmount?.toFixed(2) }}</a-descriptions-item>
        <a-descriptions-item label="价税合计">¥{{ currentOrder?.totalAmountWithTax?.toFixed(2) }}</a-descriptions-item>
