        ...
        <a-row :gutter="24">
          <a-col :span="8">
            <a-form-item label="供应商编码" name="supplierCode">
              <a-input size="small" v-model:value="form.supplierCode" placeholder="留空自动生成">
                <template #suffix>
          ...
          <a-col :span="8">
            <a-form-item label="供应商类型" name="supplierType">
              <a-select v-model:value="form.supplierType" size="small">
          ...
          <a-col :span="8">
            <a-form-item label="供应商等级" name="supplierLevel">
              <a-select v-model:value="form.supplierLevel" size="small">
          ...
          <a-col :span="8">
            <a-form-item label="合作状态" name="cooperationStatus">
              <a-select v-model:value="form.cooperationStatus" size="small">
...
import { SaveOutlined, WarningOutlined, ReloadOutlined } from '@ant-design/icons-vue'
