...
public class SyncConfigController {
    ...
    public ResponseEntity<List<Map<String, String>>> getSupportedSources() {
        return ResponseEntity.ok(syncConfigService.getSupportedSources());
    }
    ...
    public ResponseEntity<SyncDataSourceConfig> createConfig(@RequestBody SyncDataSourceConfig config) {
    ...
    public ResponseEntity<SyncDataSourceConfig> updateConfig(
    ...
    public ResponseEntity<SyncDataSourceConfig> getConfig(@PathVariable Long id) {
    ...
    public ResponseEntity<List<SyncDataSourceConfig>> listConfigs() {
        return ResponseEntity.ok(syncConfigService.listConfigs());
    }
    ...
    public ResponseEntity<Map<String, Object>> testConnection(@PathVariable Long id) {
        return ResponseEntity.ok(syncConfigService.testConnection(id));
    }
    ...
    public ResponseEntity<Map<String, Object>> triggerSync(
        ...
        return ResponseEntity.ok(syncConfigService.triggerSync(id, syncType));
    }
}
