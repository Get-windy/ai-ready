...
@TableName("erp_supplier_benefit_record")
@Entity
@Table(name = "erp_supplier_benefit_record", indexes = {
    ...
    @Index(name = "idx_related_business_id", columnList = "related_business_id")
})
public class SupplierBenefitRecordEntity {
    ...
    /**
     * 记录类型：ISSUE-发放，USE-使用，EXCHANGE-兑换，REVOKE-撤销，EXPIRE-过期
     */
    ...
    /**
     * 关联业务类型：ORDER-订单，QUOTATION-报价，PAYMENT-付款，OTHER-其他
     */
