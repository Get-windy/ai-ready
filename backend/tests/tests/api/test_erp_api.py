...
# -*- coding: utf-8 -*-
"""
API自动化测试 - ERP模块API (重构版)
测试范围: 产品、库存、采购订单、销售订单、财务科目

重构变更:
- 使用 utils.test_helpers.assert_success 统一响应断言
- 使用 utils.test_helpers.assert_field_exists 统一字段校验
- 移除各 class 中重复的 client fixture，改为继承 BaseERPTest
"""
...
class TestERPProductAPI(BaseERPTest):
    """ERP产品API测试"""
    ...
    def test_product_list_page(self, client):
        ...
        data = assert_success(response, msg="产品分页查询")
        assert_field_exists(data, 'data', msg="响应缺少 data 字段")
    ...
    def test_product_create(self, client):
        ...
        assert_success(response, expected_status=[200, 201], msg="产品创建")
    ...
    def test_product_update(self, client):
        ...
        assert_success(response, expected_status=[200, 204], msg="产品更新")
    ...
    def test_product_search(self, client):
        ...
        assert_success(response, msg="产品搜索")


class TestERPStockAPI(BaseERPTest):
    """ERP库存API测试"""
    ...
    def test_stock_list(self, client):
        ...
        assert_success(response, msg="库存列表查询")
    ...
    def test_stock_in(self, client):
        ...
        assert_success(response, expected_status=[200, 201], msg="库存入库")
    ...
    def test_stock_out(self, client):
        ...
        assert_success(response, expected_status=[200, 201, 400], msg="库存出库")
...
class TestERPPurchaseAPI(BaseERPTest):
    """ERP采购订单API测试"""
    ...
    def test_purchase_order_list(self, client):
        ...
        assert_success(response, msg="采购订单列表")
    ...
    def test_purchase_order_create(self, client):
        ...
        assert_success(response, expected_status=[200, 201], msg="创建采购订单")
...
class TestERPSalesAPI(BaseERPTest):
    """ERP销售订单API测试"""
    ...
    def test_sales_order_list(self, client):
        ...
        assert_success(response, msg="销售订单列表")
    ...
    def test_sales_order_create(self, client):
        ...
        assert_success(response, expected_status=[200, 201], msg="创建销售订单")
...
class TestERPAccountAPI(BaseERPTest):
    """ERP财务科目API测试"""
    ...
    def test_account_list(self, client):
        ...
        assert_success(response, msg="会计科目列表")
...
class TestERPReportAPI(BaseERPTest):
    """ERP报表API测试"""
