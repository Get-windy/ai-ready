...
# -*- coding: utf-8 -*-
"""
API自动化测试 - CRM模块API (重构版)
测试范围: 客户、线索、商机、活动、报表

重构变更:
- 使用 utils.test_helpers.assert_success 统一响应断言
- 移除各 class 中重复的 client fixture，改为继承 BaseCRMTest
- 统一使用 round() 避免浮点数精度问题
"""
...
class TestCRMCustomerAPI(BaseCRMTest):
    """CRM客户API测试"""
    ...
    def test_customer_list(self, client):
        ...
        data = assert_success(response, msg="客户列表查询")
        assert_field_exists(data, 'code', msg="响应缺少 code 字段")
    ...
    def test_customer_create(self, client):
        ...
        assert_success(response, expected_status=[200, 201], msg="客户创建")
...
class TestCRMLeadAPI(BaseCRMTest):
    """CRM线索API测试"""
    ...
    def test_lead_list(self, client):
        ...
        assert_success(response, msg="线索列表")
    ...
    def test_lead_create(self, client):
        ...
        assert_success(response, expected_status=[200, 201], msg="线索创建")
...
class TestCRMOpportunityAPI(BaseCRMTest):
    """CRM商机API测试"""
    ...
    def test_opportunity_list(self, client):
        ...
        assert_success(response, msg="商机列表")
    ...
    def test_opportunity_create(self, client):
        ...
        opp_data = {
            ...
            'customerId': 1,
            'expectedAmount': round(random.uniform(10000, 100000), 2),
        ...
        assert_success(response, expected_status=[200, 201], msg="商机创建")
...
class TestCRMActivityAPI(BaseCRMTest):
    """CRM活动API测试"""
    ...
    def test_activity_list(self, client):
        ...
        assert_success(response, msg="活动列表")
    ...
    def test_activity_create(self, client):
        ...
        assert_success(response, expected_status=[200, 201], msg="活动创建")
...
class TestCRMReportAPI(BaseCRMTest):
    """CRM报表API测试"""
...
class TestCRMIntegrationAPI(BaseCRMTest):
    """CRM集成API测试 - 完整业务流程"""
    ...
    def test_lead_to_order_flow(self, client):
        ...
        assert_success(lead_resp, expected_status=[200, 201], msg="流程-创建线索")
