...
from utils.test_helpers import TestConfig, assert_success, assert_field_exists


# ==================== 配置 ====================
# 重构说明: 已迁移到 utils.test_helpers.TestConfig，保留别名以兼容现有代码
CONFIG = TestConfig(
    report_path="H:\\OpenClaw_Works\\AI_READY_CORE_API_TEST_REPORT.md"
)
